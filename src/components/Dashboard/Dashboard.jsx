...
function Dashboard() {
  function handleClick(id){
    alert (id.namaProduk + " dengan harga " + id.hargaProduk + " memliki harga yang bersaing dengan kualitas produk yang sangat baik")
  }
  ...
  return (
    listProduct.map((id) => {
        return <CardProduk key={id} namaProduk={id.productName} hargaProduk={id.productPrice} imageProduk={id.urlImage} handleClick={() => handleClick(id)}/>
    })
  )
}
